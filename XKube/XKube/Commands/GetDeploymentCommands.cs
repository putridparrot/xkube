...
public class GetDeploymentCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetDeploymentCommands.Settings>
{
    ...
    {
        var items = await kubernetesClientServices.GetDeploymentsAsync(settings.AllNamespaces ? null : settings.Namespace ?? kubernetesClientServices.CurrentNamespace);
