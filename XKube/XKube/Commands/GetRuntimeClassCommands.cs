...
public class GetRuntimeClassCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetRuntimeClassCommands.Settings>
{
    ...
    {
        var items = await kubernetesClientServices.GetRuntimeClassesAsync();
