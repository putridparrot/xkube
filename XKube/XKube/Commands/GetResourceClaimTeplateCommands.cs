...
public class GetResourceClaimTeplateCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetResourceClaimTeplateCommands.Settings>
{
    public sealed class Settings : CommandSettings
    {
        [CommandOption("-n|--namespace")]
        [Description("Filter Resource Claim Templates by namespace")]
    ...
    {
        var items = await kubernetesClientServices.GetResourceClaimTemplatesAsync(settings.AllNamespaces ? null : settings.Namespace ?? kubernetesClientServices.CurrentNamespace);
