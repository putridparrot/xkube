...
public class GetPriorityClassCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetPriorityClassCommands.Settings>
{
    ...
    {
        var items = await kubernetesClientServices.GetPriorityClassesAsync();
