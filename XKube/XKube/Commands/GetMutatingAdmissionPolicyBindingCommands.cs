...
public class GetMutatingAdmissionPolicyBindingCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetMutatingAdmissionPolicyBindingCommands.Settings>
{
    ...
    {
        var items = await kubernetesClientServices.GetMutatingAdmissionPolicyBindingsAsync();
