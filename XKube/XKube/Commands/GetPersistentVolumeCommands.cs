...
public class GetPersistentVolumeCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetPersistentVolumeCommands.Settings>
{
    ...
    {
        var items = await kubernetesClientServices.GetPersistentVolumesAsync();
