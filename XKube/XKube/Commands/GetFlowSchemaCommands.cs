...
public class GetFlowSchemaCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetFlowSchemaCommands.Settings>
{
    ...
    {
        var items = await kubernetesClientServices.GetFlowSchemasAsync();
