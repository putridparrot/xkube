...
public class GetValidatingAdmissionPolicyBindingCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetValidatingAdmissionPolicyBindingCommands.Settings>
{
    ...
    {
        var items = await kubernetesClientServices.GetValidatingAdmissionPolicyBindingsAsync();
