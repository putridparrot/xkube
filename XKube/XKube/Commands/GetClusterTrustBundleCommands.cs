...
public class GetClusterTrustBundleCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetClusterTrustBundleCommands.Settings>
{
    ...
    {
        var items = await kubernetesClientServices.GetClusterTrustBundlesAsync();
