...
public class GetResourceSliceCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetResourceSliceCommands.Settings>
{
    ...
    {
        var items = await kubernetesClientServices.GetResourceSlicesAsync();
