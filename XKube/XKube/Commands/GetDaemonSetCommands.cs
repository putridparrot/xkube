...
public class GetDaemonSetCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetDaemonSetCommands.Settings>
{
    public sealed class Settings : CommandSettings
    {
        [CommandOption("-n|--namespace")]
        [Description("Filter Daemon Sets by namespace")]
    ...
    {
        var items = await kubernetesClientServices.GetDaemonSetsAsync(settings.AllNamespaces ? null : settings.Namespace ?? kubernetesClientServices.CurrentNamespace);
