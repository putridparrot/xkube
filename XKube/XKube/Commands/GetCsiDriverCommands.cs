...
public class GetCsiDriverCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetCsiDriverCommands.Settings>
{
    ...
    public override async Task<int> ExecuteAsync(CommandContext context, Settings settings)
    {
        ...
        var items = await kubernetesClientServices.GetCsiDriversAsync();
