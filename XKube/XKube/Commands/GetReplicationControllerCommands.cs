...
public class GetReplicationControllerCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetReplicationControllerCommands.Settings>
{
    public sealed class Settings : CommandSettings
    {
        [CommandOption("-n|--namespace")]
        [Description("Filter Replication Controllers by namespace")]
    ...
    {
        var items = await kubernetesClientServices.GetReplicationControllersAsync(settings.AllNamespaces ? null : settings.Namespace ?? kubernetesClientServices.CurrentNamespace);
