...
public class GetHorizontalPodAutoscalerCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetHorizontalPodAutoscalerCommands.Settings>
{
    public sealed class Settings : CommandSettings
    {
        [CommandOption("-n|--namespace")]
        [Description("Filter Horizontal Pod Autoscalers by namespace")]
    ...
    {
        var items = await kubernetesClientServices.GetHorizontalPodAutoscalersAsync(settings.AllNamespaces ? null : settings.Namespace ?? kubernetesClientServices.CurrentNamespace);
