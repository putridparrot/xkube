...
public class GetEndpointSliceCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetEndpointSliceCommands.Settings>
{
    public sealed class Settings : CommandSettings
    {
        [CommandOption("-n|--namespace")]
        [Description("Filter Endpoint Slices by namespace")]
    ...
    {
        var items = await kubernetesClientServices.GetEndpointSlicesAsync(settings.AllNamespaces ? null : settings.Namespace ?? kubernetesClientServices.CurrentNamespace);
