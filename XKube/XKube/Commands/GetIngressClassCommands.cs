...
public class GetIngressClassCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetIngressClassCommands.Settings>
{
    ...
    {
        var items = await kubernetesClientServices.GetIngressClassesAsync();
