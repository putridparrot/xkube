...
public class GetPriorityLevelConfigurationCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetPriorityLevelConfigurationCommands.Settings>
{
    ...
    public override async Task<int> ExecuteAsync(CommandContext context, Settings settings)
    {
        ...
        var items = await kubernetesClientServices.GetPriorityLevelConfigurationsAsync();
