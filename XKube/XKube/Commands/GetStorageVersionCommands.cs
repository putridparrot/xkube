...
public class GetStorageVersionCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetStorageVersionCommands.Settings>
{
    ...
    public override async Task<int> ExecuteAsync(CommandContext context, Settings settings)
    {
        ...
        var items = await kubernetesClientServices.GetStorageVersionsAsync();
