...
public class GetMutatingWebhookConfigurationCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetMutatingWebhookConfigurationCommands.Settings>
{
    ...
    public override async Task<int> ExecuteAsync(CommandContext context, Settings settings)
    {
        ...
        var items = await kubernetesClientServices.GetMutatingWebhookConfigurationsAsync();
