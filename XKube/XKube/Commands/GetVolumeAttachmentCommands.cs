...
public class GetVolumeAttachmentCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetVolumeAttachmentCommands.Settings>
{
    ...
    public override async Task<int> ExecuteAsync(CommandContext context, Settings settings)
    {
        ...
        var items = await kubernetesClientServices.GetVolumeAttachmentsAsync();
