...
public class GetLimitRangeCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetLimitRangeCommands.Settings>
{
    public sealed class Settings : CommandSettings
    {
        [CommandOption("-n|--namespace")]
        [Description("Filter Limit Ranges by namespace")]
    ...
    {
        var items = await kubernetesClientServices.GetLimitRangesAsync(settings.AllNamespaces ? null : settings.Namespace ?? kubernetesClientServices.CurrentNamespace);
