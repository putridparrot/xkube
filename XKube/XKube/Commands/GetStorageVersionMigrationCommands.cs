...
public class GetStorageVersionMigrationCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetStorageVersionMigrationCommands.Settings>
{
    ...
    {
        var items = await kubernetesClientServices.GetStorageVersionMigrationsAsync();
