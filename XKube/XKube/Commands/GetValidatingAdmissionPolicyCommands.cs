...
public class GetValidatingAdmissionPolicyCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetValidatingAdmissionPolicyCommands.Settings>
{
    ...
    public override async Task<int> ExecuteAsync(CommandContext context, Settings settings)
    {
        ...
        var items = await kubernetesClientServices.GetValidatingAdmissionPoliciesAsync();
