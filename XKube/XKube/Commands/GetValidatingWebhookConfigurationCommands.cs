...
public class GetValidatingWebhookConfigurationCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetValidatingWebhookConfigurationCommands.Settings>
{
    ...
    {
        var items = await kubernetesClientServices.GetValidatingWebhookConfigurationsAsync();
