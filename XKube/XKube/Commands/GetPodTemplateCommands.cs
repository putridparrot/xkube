...
public class GetPodTemplateCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetPodTemplateCommands.Settings>
{
    public sealed class Settings : CommandSettings
    {
        [CommandOption("-n|--namespace")]
        [Description("Filter Pod Templates by namespace")]
    ...
    {
        var items = await kubernetesClientServices.GetPodTemplatesAsync(settings.AllNamespaces ? null : settings.Namespace ?? kubernetesClientServices.CurrentNamespace);
