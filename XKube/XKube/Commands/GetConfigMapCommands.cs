...
public class GetConfigMapCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetConfigMapCommands.Settings>
{
    public sealed class Settings : CommandSettings
    {
        [CommandOption("-n|--namespace")]
        [Description("Filter Config Maps by namespace")]
    ...
    {
        var items = await kubernetesClientServices.GetConfigMapsAsync(settings.AllNamespaces ? null : settings.Namespace ?? kubernetesClientServices.CurrentNamespace);
