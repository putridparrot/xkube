...
public class GetCustomResourceDefinitionCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetCustomResourceDefinitionCommands.Settings>
{
    ...
    {
        var items = await kubernetesClientServices.GetCustomResourceDefinitionsAsync();
