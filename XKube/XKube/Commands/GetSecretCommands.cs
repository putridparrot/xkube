...
public class GetSecretCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetSecretCommands.Settings>
{
    ...
    public override async Task<int> ExecuteAsync(CommandContext context, Settings settings)
    {
        ...
        var items = await kubernetesClientServices.GetSecretsAsync(settings.AllNamespaces ? null : settings.Namespace ?? kubernetesClientServices.CurrentNamespace);
