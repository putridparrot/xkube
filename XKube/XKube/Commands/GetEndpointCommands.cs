...
public class GetEndpointCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetEndpointCommands.Settings>
{
    public sealed class Settings : CommandSettings
    {
        [CommandOption("-n|--namespace")]
        [Description("Filter Endpoints by namespace")]
    ...
    {
        var items = await kubernetesClientServices.GetEndpointsAsync(settings.AllNamespaces ? null : settings.Namespace ?? kubernetesClientServices.CurrentNamespace);
