...
public class GetResourceQuotasCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetResourceQuotasCommands.Settings>
{
    public sealed class Settings : CommandSettings
    {
        [CommandOption("-n|--namespace")]
        [Description("Filter Resource Quotas by namespace")]
    ...
    {
        var items = await kubernetesClientServices.GetResourceQuotasAsync(settings.AllNamespaces ? null : settings.Namespace ?? kubernetesClientServices.CurrentNamespace);
