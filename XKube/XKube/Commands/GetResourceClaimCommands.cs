...
public class GetResourceClaimCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetResourceClaimCommands.Settings>
{
    public sealed class Settings : CommandSettings
    {
        [CommandOption("-n|--namespace")]
        [Description("Filter Resource Claims by namespace")]
    ...
    {
        var items = await kubernetesClientServices.GetResourceClaimsAsync(settings.AllNamespaces ? null : settings.Namespace ?? kubernetesClientServices.CurrentNamespace);
