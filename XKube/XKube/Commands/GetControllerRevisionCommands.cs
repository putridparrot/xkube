...
public class GetControllerRevisionCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetControllerRevisionCommands.Settings>
{
    public sealed class Settings : CommandSettings
    {
        [CommandOption("-n|--namespace")]
        [Description("Filter Controller Revisions by namespace")]
    ...
    {
        var items = await kubernetesClientServices.GetControllerRevisionsAsync(settings.AllNamespaces ? null : settings.Namespace ?? kubernetesClientServices.CurrentNamespace);
