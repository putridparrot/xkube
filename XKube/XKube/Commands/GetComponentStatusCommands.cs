...
public class GetComponentStatusCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetComponentStatusCommands.Settings>
{
    ...
    {
        var items = await kubernetesClientServices.GetComponentStatusesAsync();
