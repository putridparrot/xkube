...
public class GetVolumeAttributeCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetVolumeAttributeCommands.Settings>
{
    ...
    {
        var items = await kubernetesClientServices.GetVolumeAttributesClassesAsync();
