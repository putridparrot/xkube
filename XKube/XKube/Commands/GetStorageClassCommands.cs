...
public class GetStorageClassCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetStorageClassCommands.Settings>
{
    ...
    {
        var items = await kubernetesClientServices.GetStorageClassesAsync();
