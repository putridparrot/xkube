...
public class GetRoleCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetRoleCommands.Settings>
{
    public sealed class Settings : CommandSettings
    {
        [CommandOption("-n|--namespace")]
        [Description("Filter Roles by namespace")]
    ...
    {
        var items = await kubernetesClientServices.GetRolesAsync(settings.AllNamespaces ? null : settings.Namespace ?? kubernetesClientServices.CurrentNamespace);
