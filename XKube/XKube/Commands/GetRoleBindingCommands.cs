...
public class GetRoleBindingCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetRoleBindingCommands.Settings>
{
    ...
    public override async Task<int> ExecuteAsync(CommandContext context, Settings settings)
    {
        ...
        var items = await kubernetesClientServices.GetRoleBindingsAsync(settings.AllNamespaces ? null : settings.Namespace ?? kubernetesClientServices.CurrentNamespace);
