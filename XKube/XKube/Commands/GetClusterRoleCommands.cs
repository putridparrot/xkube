...
public class GetClusterRoleCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetClusterRoleCommands.Settings>
{
    ...
    {
        var items = await kubernetesClientServices.GetClusterRolesAsync();
