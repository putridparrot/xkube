...
public class GetNamespaceCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetNamespaceCommands.Settings>
{
    ...
    {
        var items = await kubernetesClientServices.GetNamespacesAsync();
