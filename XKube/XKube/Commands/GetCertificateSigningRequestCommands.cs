...
public class GetCertificateSigningRequestCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetCertificateSigningRequestCommands.Settings>
{
    ...
    {
        var items = await kubernetesClientServices.GetCertificateSigningRequestsAsync();
