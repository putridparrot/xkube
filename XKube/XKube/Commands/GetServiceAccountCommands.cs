...
public class GetServiceAccountCommands(IKubernetesClientService kubernetesClientServices) : AsyncCommand<GetServiceAccountCommands.Settings>
{
    public sealed class Settings : CommandSettings
    {
        [CommandOption("-n|--namespace")]
        [Description("Filter Service Accounts by namespace")]
    ...
    {
        var items = await kubernetesClientServices.GetServiceAccountsAsync(settings.AllNamespaces ? null : settings.Namespace ?? kubernetesClientServices.CurrentNamespace);
